...
/**
 * The {@code inter.pix.models.DueBillingValue} class represents the structure of a billing
...
public class DueBillingValue extends AbstractModel {
    ...
    /**
     * Constructs a new inter.pix.models.DueBillingValue with specified values.
     *
