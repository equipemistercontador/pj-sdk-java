...
/**
 * The {@code DarfPaymentBatch} class represents a batch of DARF payments
 * in a payment processing system. It includes details such as the payment type,
...
public class DarfPaymentBatch extends DarfPayment implements BatchItem {

    /**
     * The payment type, which is always "DARF".
     */
    @JsonProperty("tipoPagamento")
    private final String paymentType = "DARF";
